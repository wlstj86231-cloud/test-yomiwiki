...
export async function onRequestGet({request,params}){
  ...
  const schema=JSON.stringify({'@context':'https://schema.org','@type':'Article',headline:page.title,description:page.description,datePublished:'2026-08-09',dateModified:'2026-08-10',inLanguage:'ko-KR',mainEntityOfPage:canonical,author:{'@type':'Organization',name:'요미위키 편집팀'},publisher:{'@type':'Organization',name:'요미위키',url:'https://yomiwiki.com/'}}).replace(/</g,'\\u003c');
