const pages = {
  ...
  'trade-terms': {
    title:'농산물·농기계 거래 용어: 경락가·단량·실중량 읽는 법', category:'거래용어', modified:'2026-09-16',
    ...
    sections:[
      ['경락가·평균가격·직거래 판매가',['경락가는 경매에서 거래가 성립한 가격입니다. 시세표의 평균가격은 조회 조건에 속한 거래를 집계한 값이므로 모든 물량이 그 금액에 거래됐다는 뜻은 아닙니다.','가락시장 주요 품목 가격 자료에는 등급·거래수량·거래단위수량·평균가격이 따로 제공됩니다. 가격 숫자만 옮기지 말고 기준일·시장·품목·품종·등급·단위를 함께 기록합니다.','직거래 판매가는 판매자가 제시한 조건의 가격입니다. 도매시장 참고가격과 실제 소비자 결제액을 구분하고 배송·선별·포장 조건을 덧붙입니다.'],['조회 조건을 맞춘 뒤 가락시장 시세표 확인하기','https://boribay.com/guides/garak-market-price-lookup?utm_source=yomiwiki.com&utm_medium=owned_referral&utm_campaign=knowledge_article&utm_content=auction_price_terms']],
    ...
    faq:[['가락시장 평균가격을 그대로 내 판매가격으로 적어도 되나요?','시세의 기준일·등급·단위와 내 상품 조건이 같은지 먼저 봅니다. 참고 시세와 판매자가 정한 상품금액·배송비를 따로 표시해야 구매자가 실제 결제조건을 알 수 있습니다.'],['10kg 상자가 5kg 상자보다 항상 저렴한가요?','상자 가격만으로 판단할 수 없습니다. 같은 품질 조건에서 내용량과 실제 적용 배송비를 확인해 kg당 가격을 비교합니다.']],
    sources:[['서울특별시농수산식품공사 주요 품목 가격 항목','https://www.data.go.kr/data/15004517/openapi.do'],['농산물 표준규격제도','https://www.naqs.go.kr/hp/contents/contentsTab.do?menuId=MN30614']],related:[['농산물 등급표 읽는 법','produce-grading'],['농기계 거래 기본','farm-machinery'],['농산물 품목별 확인','produce-items']],boribay:'https://boribay.com/guides/agricultural-wholesale-market-guide?utm_source=yomiwiki.com&utm_medium=owned_referral&utm_campaign=knowledge_article&utm_content=trade_terms',boribayText:'농산물 도매시장 거래 구조 보기'
  },
  'farm-waste-terms': {
